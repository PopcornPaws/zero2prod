...
///
/// We are using `impl Subscriber` as retrun type to avoid having to spell out
...
pub fn get_subscriber(name: String, env_filter_name: String) -> impl Subscriber + Send + Sync {
    let env_filter =
...
/// Register a subscriber as gobal default to process span data.
///
